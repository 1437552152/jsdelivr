 ...
 */ !(function (n) {
  ...
  function (n, e, t) {
    ...
    function v(n, e, t, r) {
      n.beginPath(),
        n.moveTo(e, t),
        n.arc(e + a / 2, t - c + 2, c, 0.72 * l, 2.26 * l),
        n.lineTo(e + a, t),
        n.arc(e + a + c - 2, t + a / 2, c, 1.21 * l, 2.78 * l),
        n.lineTo(e + a, t + a),
        n.lineTo(e, t + a),
        n.arc(e + c - 2, t + a / 2, c + 0.4, 2.76 * l, 1.24 * l, !0),
        n.lineTo(e, t),
        (n.lineWidth = 2),
          ...
          },
          {
            ...
            value: function () {
              ...
              var i = f("div", "refreshIcon"),
                ...
                l = f("span", "sliderIcon"),
                u = f("span", "sliderText");
              (e.className = "block"), (u.innerHTML = "Slide right to fill the puzzle");
              var d = this.el;
              d.appendChild(n),
                d.appendChild(i),
                d.appendChild(e),
            ...
            value: function () {
              ...
              var e = void 0,
                ...
                c = function (t) {
                  ...
                  c
                    ? l
                      ? (p(n.sliderContainer, "sliderContainer_success"),
                        "function" == typeof n.onSuccess && n.onSuccess())
                      : (p(n.sliderContainer, "sliderContainer_fail"),
